...
(
    block_id_hash character(64) NOT NULL,
    block_id_parts_hash character(64) NOT NULL,
    ...
    block_last_block_id_hash character(64) NOT NULL,
    block_last_block_id_parts_hash character(64) NOT NULL,
